...
undefined4
GENERIC_PHY_SchedulePacketRx(undefined4 param_1,int param_2,int param_3,int param_4,char param_5,undefined param_6)

{
  ...
  if (param_4 != 2) 
  {
    ...
    if ((iVar3 == 0) && (uVar4 = (RAC->STATUS), -1 < (int)(uVar4 << 0x11))) 
	{
      CORE_ExitCritical(uVar1);
      return 4;
    }
