...
//radio registers
#include "efr32fg1v_agc.h"
#include "efr32fg1v_crc.h"
#include "efr32fg1v_frc.h"
#include "efr32fg1v_modem.h"
#include "efr32fg1v_rac.h"
#include "efr32fg1v_synth.h"
#include "efr32fg1v_protimer.h"
#include "efr32fg1v_rfsense.h"
#include "efr32fg1v_bufc.h"
#include "efr32fg1v_seq.h"
...
#define FRC_SET_BASE                0x46080000UL
#define MODEM_CLR_BASE              0x44086000UL
#define MODEM_SET_BASE              0x46086000UL
#define RAC_CLR_BASE                0x44084000UL
#define RAC_SET_BASE                0x46084000UL
#define SYNTH_CLR_BASE              0x44083000UL
#define SYNTH_SET_BASE              0x46083000UL
#define PROTIMER_CLR_BASE           0x44085000UL
#define PROTIMER_SET_BASE           0x46085000UL
#define RFSENSE_CLR_BASE            0x44088000UL
#define RFSENSE_SET_BASE            0x46088000UL
#define BUFC_CLR_BASE               0x44081000UL
#define BUFC_SET_BASE               0x46081000UL
#define MSC_CLR_BASE                0x440E0000UL
#define MSC_SET_BASE                0x460E0000UL
#define CMU_CLR_BASE                0x440E4000UL
#define CMU_SET_BASE                0x460E4000UL
#define CRYPTO_CLR_BASE             0x440F0000UL
#define CRYPTO_SET_BASE             0x460F0000UL
#define GPIO_CLR_BASE               0x4400A000UL
#define GPIO_SET_BASE               0x4600A000UL
#define PRS_CLR_BASE                0x440E6000UL
#define PRS_SET_BASE                0x460E6000UL
#define LDMA_CLR_BASE               0x440E2000UL
#define LDMA_SET_BASE               0x460E2000UL
#define FPUEH_CLR_BASE              0x440E1000UL
#define FPUEH_SET_BASE              0x460E1000UL
#define GPCRC_CLR_BASE              0x4401C000UL
#define GPCRC_SET_BASE              0x4601C000UL
#define TIMER0_CLR_BASE             0x44018000UL
#define TIMER0_SET_BASE             0x46018000UL
#define TIMER1_CLR_BASE             0x44018400UL
#define TIMER1_SET_BASE             0x46018400UL
#define USART0_CLR_BASE             0x44010000UL
#define USART0_SET_BASE             0x46010000UL
#define USART1_CLR_BASE             0x44010400UL
#define USART1_SET_BASE             0x46010400UL
#define LEUART0_CLR_BASE            0x4404A000UL
#define LEUART0_SET_BASE            0x4604A000UL
#define LETIMER0_CLR_BASE           0x44046000UL
#define LETIMER0_SET_BASE           0x46046000UL
#define PCNT0_CLR_BASE              0x4404E000UL
#define PCNT0_SET_BASE              0x4604E000UL
#define I2C0_CLR_BASE               0x4400C000UL
#define I2C0_SET_BASE               0x4600C000UL
#define ADC0_CLR_BASE               0x44002000UL
#define ADC0_SET_BASE               0x46002000UL
#define ACMP0_CLR_BASE              0x44000000UL
#define ACMP0_SET_BASE              0x46000000UL
#define ACMP1_CLR_BASE              0x44000400UL
#define ACMP1_SET_BASE              0x46000400UL
#define IDAC0_CLR_BASE              0x44006000UL
#define IDAC0_SET_BASE              0x46006000UL
#define RTCC_CLR_BASE               0x44042000UL
...
#define FRC_SET                     ((FRC_Typedef*)           FRC_SET_BASE)
#define MODEM_CLR                   ((MODEM_Typedef*)         MODEM_CLR_BASE)
#define MODEM_SET                   ((MODEM_Typedef*)         MODEM_SET_BASE)
#define RAC_CLR                     ((RAC_Typedef*)           RAC_CLR_BASE)
#define RAC_SET                     ((RAC_Typedef*)           RAC_SET_BASE)
#define SYNTH_CLR                   ((SYNTH_Typedef*)         SYNTH_CLR_BASE)
#define SYNTH_SET                   ((SYNTH_Typedef*)         SYNTH_SET_BASE)
#define PROTIMER_CLR                ((PROTIMER_Typedef*)      PROTIMER_CLR_BASE)
#define PROTIMER_SET                ((PROTIMER_Typedef*)      PROTIMER_SET_BASE)
#define RFSENSE_CLR                 ((RFSENSE_Typedef*)       RFSENSE_CLR_BASE)
#define RFSENSE_SET                 ((RFSENSE_Typedef*)       RFSENSE_SET_BASE)
#define BUFC_CLR                    ((BUFC_Typedef*)          BUFC_CLR_BASE)
#define BUFC_SET                    ((BUFC_Typedef*)          BUFC_SET_BASE)
#define MSC_CLR                     ((MSC_Typedef*)           MSC_CLR_BASE)
#define MSC_SET                     ((MSC_Typedef*)           MSC_SET_BASE)
#define CMU_CLR                     ((CMU_Typedef*)           CMU_CLR_BASE)
#define CMU_SET                     ((CMU_Typedef*)           CMU_SET_BASE)
#define CRYPTO_CLR                  ((CRYPTO_Typedef*)        CRYPTO_CLR_BASE)
#define CRYPTO_SET                  ((CRYPTO_Typedef*)        CRYPTO_SET_BASE)
#define GPIO_CLR                    ((GPIO_Typedef*)          GPIO_CLR_BASE)
#define GPIO_SET                    ((GPIO_Typedef*)          GPIO_SET_BASE)
#define PRS_CLR                     ((PRS_Typedef*)           PRS_CLR_BASE)
#define PRS_SET                     ((PRS_Typedef*)           PRS_SET_BASE)
#define LDMA_CLR                    ((LDMA_Typedef*)          LDMA_CLR_BASE)
#define LDMA_SET                    ((LDMA_Typedef*)          LDMA_SET_BASE)
#define FPUEH_CLR                   ((FPUEH_Typedef*)         FPUEH_CLR_BASE)
#define FPUEH_SET                   ((FPUEH_Typedef*)         FPUEH_SET_BASE)
#define GPCRC_CLR                   ((GPCRC_Typedef*)         GPCRC_CLR_BASE)
#define GPCRC_SET                   ((GPCRC_Typedef*)         GPCRC_SET_BASE)
#define TIMER0_CLR                  ((TIMER0_Typedef*)        TIMER0_CLR_BASE)
#define TIMER0_SET                  ((TIMER0_Typedef*)        TIMER0_SET_BASE)
#define TIMER1_CLR                  ((TIMER1_Typedef*)        TIMER1_CLR_BASE)
#define TIMER1_SET                  ((TIMER1_Typedef*)        TIMER1_SET_BASE)
#define USART0_CLR                  ((USART0_Typedef*)        USART0_CLR_BASE)
#define USART0_SET                  ((USART0_Typedef*)        USART0_SET_BASE)
#define USART1_CLR                  ((USART1_Typedef*)        USART1_CLR_BASE)
#define USART1_SET                  ((USART1_Typedef*)        USART1_SET_BASE)
#define LEUART0_CLR                 ((LEUART0_Typedef*)       LEUART0_CLR_BASE)
#define LEUART0_SET                 ((LEUART0_Typedef*)       LEUART0_SET_BASE)
#define LETIMER0_CLR                ((LETIMER0_Typedef*)      LETIMER0_CLR_BASE)
#define LETIMER0_SET                ((LETIMER0_Typedef*)      LETIMER0_SET_BASE)
#define PCNT0_CLR                   ((PCNT0_Typedef*)         PCNT0_CLR_BASE)
#define PCNT0_SET                   ((PCNT0_Typedef*)         PCNT0_SET_BASE)
#define I2C0_CLR                    ((I2C0_Typedef*)          I2C0_CLR_BASE)
#define I2C0_SET                    ((I2C0_Typedef*)          I2C0_SET_BASE)
#define ADC0_CLR                    ((ADC0_Typedef*)          ADC0_CLR_BASE)
#define ADC0_SET                    ((ADC0_Typedef*)          ADC0_SET_BASE)
#define ACMP0_CLR                   ((ACMP0_Typedef*)         ACMP0_CLR_BASE)
#define ACMP0_SET                   ((ACMP0_Typedef*)         ACMP0_SET_BASE)
#define ACMP1_CLR                   ((ACMP1_Typedef*)         ACMP1_CLR_BASE)
#define ACMP1_SET                   ((ACMP1_Typedef*)         ACMP1_SET_BASE)
#define IDAC0_CLR                   ((IDAC0_Typedef*)         IDAC0_CLR_BASE)
#define IDAC0_SET                   ((IDAC0_Typedef*)         IDAC0_SET_BASE)
#define RTCC_CLR                    ((RTCC_Typedef*)          RTCC_CLR_BASE)
