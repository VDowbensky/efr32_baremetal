...
typedef struct {
  ...
  __IM uint32_t DCDCLPCMPHYSSEL1; /**< DCDC LPCMPHYSSEL Trim Register 1  */ //180
	__IM uint32_t  RESERVED15[15];
  __IM uint32_t  IRCAL0;                       /*!< IRCAL0                                                                    */
  __IM uint32_t  IRCAL1;                       /*!< IRCAL1                                                                    */
  __IM uint32_t  IRCAL2;                       /*!< IRCAL2                                                                    */
  __IM uint32_t  RESERVED16;
  __IM uint32_t  PAINFO;                       /*!< PAINFO                                                                    */
  __IM uint32_t  RESERVED17[119];
  __IM uint32_t  PACAL0;                       /*!< PACAL0                                                                    */
  __IM uint32_t  PACAL1;                       /*!< PACAL1                                                                    */
  __IM uint32_t  PACAL2;                       /*!< PACAL2                                                                    */
} DEVINFO_TypeDef;      /*!< Size = 956 (0x3bc)           /** @} */
