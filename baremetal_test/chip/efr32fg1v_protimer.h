...
#define PROTIMER_CMD_LBTPAUSE_Pos         (17UL)                    /*!< LBTPAUSE (Bit 17)                                     */
#define PROTIMER_CMD_LBTPAUSE_Msk         (0x20000UL)               /*!< LBTPAUSE (Bitfield-Mask: 0x01)                        */
...
#define PROTIMER_CC0_CTRL_INSEL_Msk       (0x0e00000UL)             /*!< INSEL (Bitfield-Mask: 0x0f)                           */
