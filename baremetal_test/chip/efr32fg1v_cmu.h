...
typedef struct {                                /*!< (@ 0x400E4000) CMU Structure                                              */
  ...
  __IOM uint32_t  RADIOCLKEN0;                  /*!< (@ 0x000000C8) High Frequency Peripheral Clock Enable Register
                                                                    0                                                          */
  ...
  __IOM uint32_t  LOCK;                         /*!< (@ 0x00000180) Configuration Lock Register                                */
	__IOM uint32_t  RESERVED24; //184
	__IOM uint32_t  RFLOCK0; 											/*!< (@ 0x00000188) Radio Configuration Lock Register                          */
} CMU_Typedef;                    /** @} */
...
#define _CMU_HFRADIOCLKEN0_MASK                             0x000003FFUL                              /**< Mask for CMU_HFRADIOCLKEN0 */
