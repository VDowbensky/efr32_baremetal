...
typedef struct {                                /*!< (@ 0x40086000) MODEM Structure                                            */
  ...
  __IM  uint32_t  FREQOFFSET;                   /*!< (@ 0x00000008) FREQOFFSET                                                 */
...
#define MODEM_TIMDETSTATUS_TIMDETFREQOFFSET_Pos (8UL)               /*!< TIMDETFREQOFFSET (Bit 8)                              */
#define MODEM_TIMDETSTATUS_TIMDETFREQOFFSET_Msk (0xff00UL)          /*!< TIMDETFREQOFFSET (Bitfield-Mask: 0xff)                */
...
/* ======================================================  FREQOFFSET  ======================================================= */
#define MODEM_FREQOFFSET_FREQOFFSET_Pos   (0UL)                     /*!< FREQOFFSET (Bit 0)                                    */
#define MODEM_FREQOFFSET_FREQOFFSET_Msk   (0xffUL)                  /*!< FREQOFFSET (Bitfield-Mask: 0xff)                      */
#define MODEM_FREQOFFSET_POE_Pos          (8UL)                     /*!< POE (Bit 8)                                           */
#define MODEM_FREQOFFSET_POE_Msk          (0xff00UL)                /*!< POE (Bitfield-Mask: 0xff)                             */
#define MODEM_FREQOFFSET_CORRVAL_Pos      (16UL)                    /*!< CORRVAL (Bit 16)                                      */
#define MODEM_FREQOFFSET_CORRVAL_Msk      (0xff0000UL)              /*!< CORRVAL (Bitfield-Mask: 0xff)                         */
#define MODEM_FREQOFFSET_SOFTVAL_Pos      (24UL)                    /*!< SOFTVAL (Bit 24)                                      */
#define MODEM_FREQOFFSET_SOFTVAL_Msk      (0xff000000UL)            /*!< SOFTVAL (Bitfield-Mask: 0xff)                         */
/* =======================================================  AFCADJRX  ======================================================== */
...
#define MODEM_CTRL1_FREQOFFSETPER_Pos     (22UL)                    /*!< FREQOFFSETPER (Bit 22)                                */
#define MODEM_CTRL1_FREQOFFSETPER_Msk     (0x1c00000UL)             /*!< FREQOFFSETPER (Bitfield-Mask: 0x07)                   */
#define MODEM_CTRL1_FREQOFFSETLIM_Pos     (25UL)                    /*!< FREQOFFSETLIM (Bit 25)                                */
#define MODEM_CTRL1_FREQOFFSETLIM_Msk     (0xfe000000UL)            /*!< FREQOFFSETLIM (Bitfield-Mask: 0x7f)                   */
/* =========================================================  CTRL2  ========================================================= */
