...
typedef struct {                                /*!< (@ 0x40081000) BUFC Structure                                             */
  ...
  __IOM uint32_t  BUF2_THRESHOLDCTRL;            /*!< (@ 0x00000084) BUF2_THRESHOLDCTR                                          */
...
/* ===================================================  BUF2_THRESHOLDCTRL  =================================================== */
#define BUFC_BUF2_THRESHOLDCTRL_THRESHOLD_Pos (0UL)                  /*!< THRESHOLD (Bit 0)                                     */
#define BUFC_BUF2_THRESHOLDCTRL_THRESHOLD_Msk (0xfffUL)              /*!< THRESHOLD (Bitfield-Mask: 0xfff)                      */
#define BUFC_BUF2_THRESHOLDCTRL_THRESHOLDMODE_Pos (13UL)             /*!< THRESHOLDMODE (Bit 13)                                */
#define BUFC_BUF2_THRESHOLDCTRL_THRESHOLDMODE_Msk (0x2000UL)         /*!< THRESHOLDMODE (Bitfield-Mask: 0x01)                   */
/* =======================================================  BUF2_CMD  ======================================================== */
