...
void init_i2c(void)
{
  ...
  I2C_PER->ROUTEPEN  = I2C_ROUTEPEN_SDAPEN | I2C_ROUTEPEN_SCLPEN;
  I2C_PER->ROUTELOC0 = (I2C_SDA_LOC << _I2C_ROUTELOC0_SDALOC_SHIFT) | (I2C_SCL_LOC << _I2C_ROUTELOC0_SCLLOC_SHIFT);
