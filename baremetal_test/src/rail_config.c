...
const uint32_t generated[] = {
  0x01010FF0UL, (uint32_t) &generated_phyInfo, //SEQ->PHYINFO
  0x01010FF4UL, 0x00000000UL, //SEQ->MISC
  0x01010FF8UL, 0x0003C002UL, //SEQ->SYNTHLPFCTRLRX
  0x01010FFCUL, 0x0003C002UL, //SEQ->SYNTHLPFCTRLTX
  ...
  0x00017014UL, 0x000270F8UL, //AGC->CTRL0
  0x00017018UL, 0x00000300UL, //AGC->CTRL1
  0x0001701CUL, 0x82710060UL, //AGC->CTRL2
