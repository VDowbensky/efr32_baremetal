...
void ITDS_setmode(uint8_t mode)
{
...
//
  ...
  ITDS_enDataReadyINT0(ITDS_enable);
  ITDS_enInterrups(ITDS_enable);
}

void compute_accel(void)
{
  ...
  if (acc_mode < 2) //14 bits
  {
      X_acc = (float) (XRawAcc >> 2);
      Y_acc = (float) (YRawAcc >> 2);
      Z_acc = (float) (ZRawAcc >> 2);
      X_acc = X_acc / 1000; /* mg to g */
      X_acc = X_acc * 1.952; /* Multiply with sensitivity 1.952 in high performance mode, 14bit, and full scale +-16g */
      Y_acc = Y_acc / 1000;
      Y_acc = (Y_acc * 1.952);
      Z_acc = Z_acc / 1000;
      Z_acc = Z_acc * 1.952;
  ...
  {
      X_acc = (float) (XRawAcc >> 4);
      Y_acc = (float) (YRawAcc >> 4);
      Z_acc = (float) (ZRawAcc >> 4);
      X_acc = X_acc / 1000; /* mg to g */
      X_acc = X_acc * 7.808; /* Multiply with sensitivity 1.952 in high performance mode, 14bit, and full scale +-16g */
      Y_acc = Y_acc / 1000;
      Y_acc = (Y_acc * 7.808);
      Z_acc = Z_acc / 1000;
      Z_acc = Z_acc * 7.808;
  ...
  //get temperature
  ITDS_getTemperature12bit(&T_acc);
}

int8_t ITDS_getDeviceID(uint8_t *device_id)
{
	uint8_t deviceID = 0xff;
	if (WE_FAIL == ReadReg((uint8_t)ITDS_DEVICE_ID_REG, 1, &deviceID)) return WE_FAIL;
	*device_id=deviceID;
	return (WE_SUCCESS);
}

void cbITDS_Irq(void)
{
  //compute_accel();
}
...
int8_t ITDS_setOutputDataRate(ITDS_output_Data_Rate odr)
{
	...
	if (WE_FAIL == ReadReg((uint8_t)ITDS_CTRL_1_REG, 1, (uint8_t *)&ctrl_reg_1)) return WE_FAIL;

	ctrl_reg_1.outputDataRate = odr;

	if (WE_FAIL == WriteReg((uint8_t)ITDS_CTRL_1_REG, 1, (uint8_t *)&ctrl_reg_1))	return WE_FAIL;
...
int8_t ITDS_reboot(ITDS_state_t rebootmode)
{
	...
	if (WE_FAIL == ReadReg((uint8_t)ITDS_CTRL_2_REG, 1, (uint8_t *)&ctrl_reg_2))	return WE_FAIL;

	ctrl_reg_2.boot = rebootmode;

	if (WE_FAIL == WriteReg((uint8_t)ITDS_CTRL_2_REG, 1, (uint8_t *)&ctrl_reg_2))	return WE_FAIL;
...
int8_t ITDS_setSelfTestMode(ITDS_self_Test_Config selfTest)
{
	...
	if (WE_FAIL == ReadReg((uint8_t)ITDS_CTRL_3_REG, 1, (uint8_t *)&ctrl_reg_3))	return WE_FAIL;

	ctrl_reg_3.selfTestMode = selfTest;

	if (WE_FAIL == WriteReg((uint8_t)ITDS_CTRL_3_REG, 1, (uint8_t *)&ctrl_reg_3))	return WE_FAIL;
...
int8_t ITDS_set6DOnINT0(ITDS_state_t int06D)
{
	...
	if (WE_FAIL == ReadReg((uint8_t)ITDS_CTRL_4_REG, 1, (uint8_t *)&ctrl_reg_4))	return WE_FAIL;

	ctrl_reg_4.sixDINT0 = int06D;

	if (WE_FAIL == WriteReg((uint8_t)ITDS_CTRL_4_REG, 1, (uint8_t *)&ctrl_reg_4))	return WE_FAIL;
...
int8_t ITDS_enInactivityINT1(ITDS_state_t intSleepState)
{
	...
	if (WE_FAIL == ReadReg((uint8_t)ITDS_CTRL_5_REG, 1, (uint8_t *)&ctrl_reg_5))	return WE_FAIL;

	ctrl_reg_5.inactiveStatusINT1 = intSleepState;

	if (WE_FAIL == WriteReg((uint8_t)ITDS_CTRL_5_REG, 1, (uint8_t *)&ctrl_reg_5))	return WE_FAIL;
...
int8_t ITDS_setFilteringCutoff(ITDS_bandwidth filteringCutoff)
{
	...
	if (WE_FAIL == ReadReg((uint8_t)ITDS_CTRL_6_REG, 1, (uint8_t *)&ctrl_reg_6))	return WE_FAIL;

	ctrl_reg_6.filterBandwidth = filteringCutoff;

	if (WE_FAIL == WriteReg((uint8_t)ITDS_CTRL_6_REG, 1, (uint8_t *)&ctrl_reg_6))	return WE_FAIL;
...
int8_t ITDS_getdataReadyState(ITDS_state_t *drdy)
{
	...
	if (WE_FAIL == ReadReg((uint8_t)ITDS_STATUS_REG, 1, (uint8_t *)&status_reg))	return WE_FAIL;
...
int8_t ITDS_getRawAccelerationX(int16_t *XRawAcc)
{
	...
	if (WE_FAIL == ReadReg((uint8_t)ITDS_X_OUT_L_REG, 2, tmp))	return WE_FAIL;
...
int8_t ITDS_getRawAccelerationY(int16_t *YRawAcc)
{
	...
	if (WE_FAIL == ReadReg((uint8_t)ITDS_Y_OUT_L_REG, 2, tmp))	return WE_FAIL;
...
int8_t ITDS_getRawAccelerationZ(int16_t *ZRawAcc)
{
	...
	if (WE_FAIL == ReadReg((uint8_t)ITDS_Z_OUT_L_REG, 2, tmp)) return WE_FAIL;
...
int8_t ITDS_getTemperature8bit(uint8_t *temp8bit)
{
	...
	if (WE_FAIL == ReadReg((uint8_t)ITDS_T_OUT_REG, 1, &temperatureValue8bit))	return WE_FAIL;
...
int8_t  ITDS_getRawTemp12bit(int16_t *temp12bit)
{
	...
	if (WE_FAIL == ReadReg((uint8_t)ITDS_T_OUT_L_REG, 1, temp))	return WE_FAIL;
	if (WE_FAIL == ReadReg((uint8_t)ITDS_T_OUT_H_REG, 1, temp + 1))	return WE_FAIL;
...
int8_t ITDS_setFifoThreshold(uint8_t fifo_Threshold)
{
	...
	if (WE_FAIL == ReadReg((uint8_t)ITDS_FIFO_CTRL_REG, 1, (uint8_t *)&fifo_ctrl_reg))	return WE_FAIL;

	fifo_ctrl_reg.fifoThresholdLevel = fifo_Threshold;

	if (WE_FAIL == WriteReg((uint8_t)ITDS_FIFO_CTRL_REG, 1, (uint8_t *)&fifo_ctrl_reg))	return WE_FAIL;
...
int8_t ITDS_getFifoThresholdState(ITDS_state_t *fifoTHR)
{
	...
	if (WE_FAIL == ReadReg((uint8_t)ITDS_FIFO_SAMPLES_REG, 1, (uint8_t *)&fifo_samples_reg))	return WE_FAIL;
...
int8_t ITDS_en4DDetection(ITDS_state_t detection4D)
{
	...
	if (WE_FAIL == ReadReg((uint8_t)ITDS_TAP_X_TH_REG, 1, (uint8_t *)&tap_x_th))	return WE_FAIL;

	tap_x_th.fourDPositionState = detection4D;

	if (WE_FAIL == WriteReg((uint8_t)ITDS_TAP_X_TH_REG, 1, (uint8_t *)&tap_x_th))	return WE_FAIL;
...
int8_t ITDS_setTapThresholdY(uint8_t tapThresholdY)
{
	...
	if (WE_FAIL == ReadReg((uint8_t)ITDS_TAP_Y_TH_REG, 1, (uint8_t *)&tap_y_th))	return WE_FAIL;

	tap_y_th.YAxisTapThreshold = tapThresholdY;

	if (WE_FAIL == WriteReg((uint8_t)ITDS_TAP_Y_TH_REG, 1, (uint8_t *)&tap_y_th))	return WE_FAIL;
...
int8_t ITDS_setTapThresholdZ(uint8_t tapThresholdZ)
{
	...
	if (WE_FAIL == ReadReg((uint8_t)ITDS_TAP_Z_TH_REG, 1, (uint8_t *)&tap_z_th))	return WE_FAIL;

	tap_z_th.ZAxisTapThreshold = tapThresholdZ;

	if (WE_FAIL == WriteReg((uint8_t)ITDS_TAP_Z_TH_REG, 1, (uint8_t *)&tap_z_th))	return WE_FAIL;
...
int8_t ITDS_setLatency(uint8_t latency_t)
{
	...
	if (WE_FAIL == ReadReg((uint8_t)ITDS_INT_DUR_REG, 1, (uint8_t *)&int_dur_t))	return WE_FAIL;

	int_dur_t.latency = latency_t;

	if (WE_FAIL == WriteReg((uint8_t)ITDS_INT_DUR_REG, 1, (uint8_t *)&int_dur_t))	return WE_FAIL;
...
int8_t ITDS_enTapEvent(ITDS_state_t singleDoubleTap)
{
	...
	if (WE_FAIL == ReadReg((uint8_t)ITDS_WAKE_UP_TH_REG, 1, (uint8_t *)&wake_up_th_t))	return WE_FAIL;

	wake_up_th_t.enTapEvent = singleDoubleTap;

	if (WE_FAIL == WriteReg((uint8_t)ITDS_WAKE_UP_TH_REG, 1, (uint8_t *)&wake_up_th_t))	return WE_FAIL;
...
int8_t ITDS_getTapEvent(ITDS_state_t *singleDoubleTap)
{
	...
	*singleDoubleTap = (ITDS_state_t)(wake_up_th_t.enTapEvent);	return WE_SUCCESS;
}
...
int8_t ITDS_setFreeFallDurationMSB(ITDS_state_t FF_DUR5)
{
	...
	if (WE_FAIL == ReadReg((uint8_t)ITDS_WAKE_UP_DUR_REG, 1, (uint8_t *)&wake_up_dur_t))	return WE_FAIL;

	wake_up_dur_t.freeFallDurationMSB = FF_DUR5;

	if (WE_FAIL == WriteReg((uint8_t)ITDS_WAKE_UP_DUR_REG, 1, (uint8_t *)&wake_up_dur_t))	return WE_FAIL;
...
int8_t ITDS_setFreeFallDurationLSB(uint8_t FF_DURLSB)
{
	...
	if (WE_FAIL == ReadReg((uint8_t)ITDS_FREE_FALL_REG, 1, (uint8_t *)&free_fall_t))	return WE_FAIL;

	free_fall_t.freeFallDurationLSB = FF_DURLSB;

	if (WE_FAIL == WriteReg((uint8_t)ITDS_FREE_FALL_REG, 1, (uint8_t *)&free_fall_t))	return WE_FAIL;
...
int8_t ITDS_getTempDrdy(ITDS_state_t *tempDrdy )
{
	...
	if (WE_FAIL == ReadReg((uint8_t)ITDS_STATUS_DETECT_REG, 1, (uint8_t *)&status_detect_t))	return WE_FAIL;
...
int8_t ITDS_getWakeupX(ITDS_state_t *wakeUpX)
{
	...
	if (WE_FAIL == ReadReg((uint8_t)ITDS_WAKE_UP_EVENT_REG, 1, (uint8_t *)&wake_up_event_t))	return WE_FAIL;
...
int8_t ITDS_getTapEventState(ITDS_state_t *tapEvent)
{
	...
	if (WE_FAIL == ReadReg((uint8_t)ITDS_TAP_EVENT_REG, 1, (uint8_t *)&tap_event_t))	return WE_FAIL;
...
int8_t ITDS_getXLOverThresholdState(ITDS_state_t *XLOverThreshold)
{
	...
	if (WE_FAIL == ReadReg((uint8_t)ITDS_6D_EVENT_REG, 1, (uint8_t *)&event_6D_t))	return WE_FAIL;
...
int8_t ITDS_getSleepChangeState(ITDS_state_t *sleep)
{
	...
	if (WE_FAIL == ReadReg((uint8_t)ITDS_ALL_INT_EVENT_REG, 1, (uint8_t *)&all_int_event_t))	return WE_FAIL;
...
int8_t ITDS_setOffsetValueOnXAxis(uint8_t offsetValueXAxis)
{
	...
	if (WE_FAIL == WriteReg((uint8_t)ITDS_X_OFS_USR_REG, 1, &offsetValueOnXAxis))	return WE_FAIL;
...
int8_t ITDS_getOffsetValueOnXAxis(uint8_t *offsetvalueXAxis)
{
	...
	if (WE_FAIL == ReadReg((uint8_t)ITDS_X_OFS_USR_REG, 1, &offsetValueOnXAxis))	return WE_FAIL;
...
int8_t ITDS_setOffsetValueOnYAxis(uint8_t offsetValueYAxis)
{
	...
	if (WE_FAIL == WriteReg((uint8_t)ITDS_Y_OFS_USR_REG, 1, &offsetValueOnYAxis))	return WE_FAIL;
...
int8_t ITDS_getOffsetValueOnYAxis(uint8_t *offsetValueYAxis)
{
	...
	if (WE_FAIL == ReadReg((uint8_t)ITDS_Y_OFS_USR_REG, 1, &offsetValueOnYAxis))	return WE_FAIL;
...
int8_t ITDS_setOffsetValueOnZAxis(uint8_t offsetvalueZAxis)
{
	...
	if (WE_FAIL == WriteReg((uint8_t)ITDS_Z_OFS_USR_REG, 1, &offsetValueOnZAxis))	return WE_FAIL;
...
int8_t ITDS_getOffsetValueOnZAxis(uint8_t *offsetValueZAxis)
{
	...
	if (WE_FAIL == ReadReg((uint8_t)ITDS_Z_OFS_USR_REG, 1, &offsetValueOnZAxis))	return WE_FAIL;
...
int8_t ITDS_setDrdyPulse(ITDS_drdy_pulse  drdyPulsed)
{
	...
	if (WE_FAIL == ReadReg((uint8_t)ITDS_CTRL_7_REG, 1, (uint8_t *)&ctrl_7_t))	return WE_FAIL;

	ctrl_7_t.drdyPulse = drdyPulsed;

	if (WE_FAIL == WriteReg((uint8_t)ITDS_CTRL_7_REG, 1, (uint8_t *)&ctrl_7_t))	return WE_FAIL;
