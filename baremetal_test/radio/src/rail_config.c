...
const uint32_t generated[] = {
  ...
  0x00016048UL, 0x0220081FUL, //MODEM->
  0x0001604CUL, 0x00000000UL, //MODEM->
  0x00016050UL, 0x00230390UL, //MODEM->
  0x00016054UL, 0x00000000UL, //MODEM->
  0x00016058UL, 0x00000000UL, //MODEM->
  0x0001605CUL, 0x22140A04UL, //MODEM->
  0x00016060UL, 0x504B4133UL, //MODEM->
  0x00016064UL, 0x00000000UL, //MODEM->
