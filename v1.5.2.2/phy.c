...

{
  ...
  if (iVar1 == 0) SYNTH_DCDCRetimeClkSet(3500000);
...

{
  ...
  do 
  {
    ...
    uVar3 = RAC->STATUS & 0xf000000;
    uVar2 = AGC->RSSI;
    uVar4 = RAC->STATUS & 0xf000000;
    sVar1 = (uint16_t)AGC->RSSI >> 6;
    CORE_ExitCritical(irqState);
    if (sVar1 != -0x200) 
	{
      if ((uVar4 == 0x2000000 || uVar4 == 0x3000000) && (uVar3 == 0x2000000 || uVar3 == 0x3000000)) return sVar1;
      return -0x200;
    }
...

{
  ...
  iVar3 = GENERIC_PHY_SetAddressData(field,field,index,0,*(undefined *)((int)&SEQ->REG054 + field + 2),value);
  if ((enable != false) && (iVar3 != 0)) return  GENERIC_PHY_EnableAddress(field,index);
