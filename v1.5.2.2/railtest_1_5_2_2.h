...
typedef union anon_union.conflict6adb_for_loc anon_union.conflict6adb_for_loc, *Panon_union.conflict6adb_for_loc;
...
union anon_union.conflict6adb_for_loc {
    struct prs_t prs;
...
struct debugSignal {
    ...
    _Bool isPrs;
    undefined field_0x5;
    union anon_union.conflict6adb_for_loc loc;
};

typedef struct debugPin debugPin_t;

typedef union anon_union.conflict6adb anon_union.conflict6adb, *Panon_union.conflict6adb;

union anon_union.conflict6adb {
    struct prs_t prs;
    uint16_t debugEventNum;
};
...
typedef enum anon_enum_8.conflict6505 {
    RAIL_IDLE=0,
    RAIL_IDLE_ABORT=1,
...
typedef enum RAIL_TxDataSource_t {
    TX_PACKET_DATA=0
} RAIL_TxDataSource_t;

typedef enum RAIL_RxDataSource_t {
    RX_DEMOD_DATA=1,
    RX_IQDATA_FILTLSB=2,
    RX_IQDATA_FILTMSB=3,
    RX_PACKET_DATA=0
...
typedef enum RAIL_DataMethod_t {
    FIFO_MODE=1,
    PACKET_MODE=0
} RAIL_DataMethod_t;

struct RAIL_DataConfig_t {
    enum RAIL_TxDataSource_t txSource;
    enum RAIL_RxDataSource_t rxSource;
    enum RAIL_DataMethod_t txMethod;
    enum RAIL_DataMethod_t rxMethod;
};
...
typedef union anon_union.conflict989_for___value anon_union.conflict989_for___value, *Panon_union.conflict989_for___value;

union anon_union.conflict989_for___value {
    wint_t __wch;
    uchar __wchb[4];
};
...
struct _mbstate_t {
    int __count;
    union anon_union.conflict989_for___value __value;
};
...
typedef union anon_union.conflict989 anon_union.conflict989, *Panon_union.conflict989;

union anon_union.conflict989 {
    wint_t __wch;
    uchar __wchb[4];
};
...
typedef union anon_union.conflict124ad anon_union.conflict124ad, *Panon_union.conflict124ad;

union anon_union.conflict124ad {
...
typedef union anon_union.conflict124ad_for_field_1 anon_union.conflict124ad_for_field_1, *Panon_union.conflict124ad_for_field_1;

union anon_union.conflict124ad_for_field_1 {
    uint16_t shortAddress;
    uint8_t longAddress[8];
};
...
struct RAIL_IEEE802154_Address {
    ...
    undefined field_0x1;
    union anon_union.conflict124ad_for_field_1 field_1;
};
...
typedef union anon_union.conflict11b6_for__new anon_union.conflict11b6_for__new, *Panon_union.conflict11b6_for__new;
...
typedef struct anon_struct.conflict100e anon_struct.conflict100e, *Panon_struct.conflict100e;
...
struct anon_struct.conflict100e {
    uint _unused_rand;
    char * _strtok_last;
...
union anon_union.conflict11b6_for__new {
    struct anon_struct.conflict100e _reent;
    struct anon_struct.conflict100e _unused;
};
...
struct _reent {
    ...
    int _cvtlen;
    char * _cvtbuf;
    union anon_union.conflict11b6_for__new _new;
    undefined field_0x128;
    undefined field_0x129;
    undefined field_0x12a;
    undefined field_0x12b;
...
typedef union anon_union.conflict11b6 anon_union.conflict11b6, *Panon_union.conflict11b6;

union anon_union.conflict11b6 {
    struct anon_struct.conflict100e _reent;
    struct anon_struct.conflict100e _unused;
...
typedef enum anon_enum_32.conflict6b41 {
...
typedef enum BSP_Peripheral_TypeDef {
    BSP_IOEXP_DISPLAY=2,
    BSP_IOEXP_LEDS=0,
    BSP_IOEXP_SENSORS=1,
    BSP_IOEXP_VCOM=3
...
// WARNING! conflicting data type names: /types.h/int32_t - /DWARF/_stdint.h/int32_t
...
void printDebugSignalHelp(char *cmdName,debugPin_t *pins,debugSignal_t *signals,uint32_t numPins,uint32_t numSignals);
...
void userCurrentLimitsSet(uint32_t maxCurrent_mA,EMU_DcdcLnReverseCurrentControl_TypeDef reverseCurrentControl);
...
int32_t appendToFormatString(char *dest,char *src,uint32_t size,uint32_t capacity,StripMode_t stripMode);
...
void PROTIMER_DelayUs(uint32_t param_1);
