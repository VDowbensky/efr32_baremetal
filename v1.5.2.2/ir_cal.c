...

{
  ...
  if ((settings != (uint8_t *)0x0) && (0x11 < *settings)) 
  {
    ...
    if (rcIrCalData[5] != '\0') rcIrCalData[5] = '\x01';
    rcIrCalData[6] = settings[7];
    if (rcIrCalData[6] != '\0') rcIrCalData[6] = '\x01';
    rcIrCalData[7] = settings[8];
    if (rcIrCalData[7] != '\0') rcIrCalData[7] = '\x01';
    if (*settings < 0x18) 
	{
      rcIrCalData[9] = settings[10];
      if (rcIrCalData[9] != '\0') rcIrCalData[9] = '\x01';
...

{
  ...
  MODEM->RAMPCTRL |= 0x800000 | (uint)rcIrCalData[2] << 0x18;
  PHY_UTILS_DelayUs(0x14);
}
...

{
  IRCAL_StopRx();
  AUXPLL_Stop();
  RAC->SGRFENCTRL0 = BUFC_RxBuffer._0_4_;
  RAC->RFENCTRL0 = BUFC_RxBuffer._4_4_;
  AGC->CTRL0 = BUFC_RxBuffer._8_4_;
  AGC->MANGAIN = BUFC_RxBuffer._12_4_;
  AGC->GAINRANGE = BUFC_RxBuffer._16_4_;
  AGC->GAININDEX = BUFC_RxBuffer._20_4_;
  AGC->MININDEX = BUFC_RxBuffer._24_4_;
  MODEM->MODINDEX = BUFC_RxBuffer._28_4_;
  MODEM->CTRL0 = BUFC_RxBuffer._32_4_;
  FRC->DFLCTRL = BUFC_RxBuffer._36_4_;
  RAC->SGPACTRL0 = BUFC_RxBuffer._40_4_;
  RAC->SGPAPKDCTRL = BUFC_RxBuffer._44_4_;
  RAC->SGPABIASCTRL0 = BUFC_RxBuffer._48_4_;
  RAC->SGPABIASCTRL1 = BUFC_RxBuffer._52_4_;
  RAC->PACTUNECTRL = BUFC_RxBuffer._56_4_;
  MODEM->RAMPCTRL = BUFC_RxBuffer._60_4_;
  RAC->TESTCTRL = BUFC_RxBuffer._64_4_;
  AGC->CTRL1 = BUFC_RxBuffer._68_4_;
  MODEM->AFC = BUFC_RxBuffer._72_4_;
  SYNTH_Config(BUFC_RxBuffer._76_4_,BUFC_RxBuffer._80_4_);
  BUFC_RxBufferReset();
...

{
  ...
  if (uVar1 == 0) uVar2 = 0xffffffff;
  else 
  {
    uVar2 = _DAT_0fe081c8;
    if ((999999999 < uVar1) && (uVar1 = (MODEM->CTRL0), uVar2 = _DAT_0fe081c4,(uVar1 << 0x17) >> 0x1d != 4)) uVar2 = _DAT_0fe081c0;
...

{
  ...
  else uVar2 = IRCAL_PerformSubfunction(iVar1,2,rcIrCalData[10],rcIrCalData._12_2_,rcIrCalData._14_2_,param_2,param_3);
  return uVar2;
}
